...
\begin{theorem}
Sample covariance has $\ell_2$ sensitivity bounded above by 
$$\left(\frac{n}{(n^2-1)}(M_i - m_i)(M_j - m_j)\right)^2.$$
\end{theorem}

\begin{proof}
% I think I maybe have to be a bit more careful about this? too tired to think through it right now. 
\end{proof}
