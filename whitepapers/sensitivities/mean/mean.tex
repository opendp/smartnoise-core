...
\begin{theorem}
Say the space of datapoints $\mathcal{X}$ is bounded above by $M$ and bounded below by $m$. Then $f(\cdot)$ has $\ell_1$-sensitivity bounded above by
$$ \frac{M-m}{n}.$$
\end{theorem}
...
\begin{theorem}
	...
	Then $f(\cdot)$ has $\ell_2$-sensitivity bounded above by
...
\begin{theorem}
Say the space of datapoints $\mathcal{X}$ is bounded above by $M$ and bounded below by $m$.
Then $f(\cdot)$ has $\ell_1$-sensitivity bounded above by
$$ \frac{M-m}{n}. $$
\end{theorem}
