...
// pub fn resize<T>(data: &ArrayD<T>, n: &u64,
//               categories: &Vec<Option<ArrayD<T>>>, probabilities: &Vec<Option<ArrayD<f64>>>, null_value: &ArrayD<Option<T>>,
...
//             Some(x) => impute_categorical(&column, &vec![categories[i as usize].unwrap()],
