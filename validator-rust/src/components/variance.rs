...
use crate::base::{Value, NodeProperties, AggregatorProperties, SensitivityType, ValueProperties, prepend, Sensitivity, ArrayNDProperties, HashmapProperties};
...
pub fn aggregate_sensitivity(
    ...
    Err("sensitivity aggregation is not implemented for Variance".into())
}