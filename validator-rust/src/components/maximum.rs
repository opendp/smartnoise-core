...
use crate::base::{Value, NodeProperties, AggregatorProperties, SensitivityType, prepend, ValueProperties, Sensitivity, HashmapProperties, ArrayNDProperties, Hashmap};
...
pub fn aggregate_sensitivity(
    ...
    Err("sensitivity aggregation is not implemented for Maximum".into())
}