...
use crate::base::{Value, NodeProperties, AggregatorProperties, SensitivityType, prepend, ValueProperties, ArrayNDProperties, Sensitivity, HashmapProperties};
...
pub fn aggregate_sensitivity(
    ...
    Err("sensitivity aggregation is not implemented for Minimum".into())
}